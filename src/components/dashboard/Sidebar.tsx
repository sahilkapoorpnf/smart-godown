...
const menuItems: Item[] = [
  ...
  { icon: Warehouse,       label: "Warehouse-wise Stock", path: "/dashboard/erp/acc/reports/warehouse-wise-stock", roles: ["wh_accountant", "admin_accountant", "accountant", "superadmin"] },
  ...
  { icon: ArrowLeftRight,  label: "Stock Movement",       path: "/dashboard/erp/acc/reports/stock-movement", roles: ["wh_accountant", "admin_accountant", "accountant", "superadmin"] },
  { icon: Package,         label: "Item-wise Stock",      path: "/dashboard/erp/acc/reports/item-wise-stock", roles: ["wh_accountant", "admin_accountant", "accountant", "superadmin"] },
  { icon: Warehouse,       label: "Godown-wise Stock",    path: "/dashboard/erp/acc/reports/godown-wise-stock", roles: ["wh_accountant", "admin_accountant", "accountant", "superadmin"] },
  ...
  { icon: BadgePercent,    label: "GST Purchase Register", path: "/dashboard/erp/acc/reports/gst-purchase", roles: ["wh_accountant", "admin_accountant", "accountant", "superadmin"] },
  { icon: BadgePercent,    label: "GST Sales Register",   path: "/dashboard/erp/acc/reports/gst-sales", roles: ["wh_accountant", "admin_accountant", "accountant", "superadmin"] },
  { icon: BadgePercent,    label: "HSN/SAC Summary",      path: "/dashboard/erp/acc/reports/hsn-summary", roles: ["wh_accountant", "admin_accountant", "accountant", "superadmin"] },
  { icon: BadgePercent,    label: "Tax Liability",        path: "/dashboard/erp/acc/reports/tax-liability", roles: ["wh_accountant", "admin_accountant", "accountant", "superadmin"] },
