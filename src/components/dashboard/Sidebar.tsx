...
const menuItems: Item[] = [
  ...
  // ===== HIMFED TALLY ERP — Accountant (Area Company-aware) =====
  ...
  { icon: BookOpen,        label: "Ledger Master",     path: "/dashboard/erp/acc/masters/ledgers",       roles: ["wh_accountant", "admin_accountant", "accountant", "superadmin"] },
  { icon: BookOpen,        label: "Voucher Type Master", path: "/dashboard/erp/acc/masters/voucher-types", roles: ["wh_accountant", "admin_accountant", "accountant", "superadmin"] },
  // Inventory Masters
  { icon: Package,         label: "Stock Groups",      path: "/dashboard/erp/acc/inventory/groups",      roles: ["wh_accountant", "admin_accountant", "accountant", "superadmin"] },
  { icon: Package,         label: "Stock Items",       path: "/dashboard/erp/acc/inventory/items",       roles: ["wh_accountant", "admin_accountant", "accountant", "superadmin"] },
  { icon: Package,         label: "Stock Units",       path: "/dashboard/erp/acc/inventory/units",       roles: ["wh_accountant", "admin_accountant", "accountant", "superadmin"] },
  { icon: Warehouse,       label: "Godown Master",     path: "/dashboard/erp/acc/inventory/godowns",     roles: ["wh_accountant", "admin_accountant", "accountant", "superadmin"] },
  // Transactions
  ...
  { icon: Warehouse,       label: "Godown Stock",      path: "/dashboard/erp/acc/reports/godown-stock",  roles: ["wh_accountant", "admin_accountant", "accountant", "superadmin"] },
