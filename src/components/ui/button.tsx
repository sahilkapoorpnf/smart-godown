  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero:
          "bg-gradient-to-r from-secondary to-accent text-secondary-foreground shadow-lg hover:shadow-xl hover:-translate-y-1 active:translate-y-0 font-bold",
        "hero-outline":
        ...
        success:
          "bg-himfed-success text-primary-foreground shadow-md hover:opacity-90 hover:shadow-lg",
        warning:
          "bg-himfed-warning text-secondary-foreground shadow-md hover:opacity-90 hover:shadow-lg",
      },
      size: {
